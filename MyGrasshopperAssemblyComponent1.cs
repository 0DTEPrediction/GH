...
public class MyGrasshopperAssemblyComponent1 : GH_Component
    {
        ...
        public MyGrasshopperAssemblyComponent1()
          : base("MyGrasshopperAssemblyComponent1", "ASpi",
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            wrapper.constructLineFromOrigin(radius0, radius1);
             
            //DA.SetData(0, wrapper.length);

            PositionWrapper s= wrapper.start();
            PositionWrapper e = wrapper.end();
 
            Point3d aa = new Point3d(s.X, s.Y, 00);
            Point3d bb = new Point3d(e.X, e.Y, 00);
            Line l0 = new Line(aa, bb);
        ...
        /// </summary>
        public override Guid ComponentGuid => new Guid("ef884f0b-737d-4de0-a298-0421b9aa695d");
    }
}